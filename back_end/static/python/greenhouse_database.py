...
# ---------------------------------------------------------------------------- #
# Developers: Aaron Ayrault, Sean McClain, Cuong Do, Andrew Kirfman            #
...
class greenhouse_database(object):
    ...
    def clean_tables(self):
        ...
        self.issue_db_command("DROP TABLE UninitializedRelay;", True)
    ...
    def construct_dummy_database(self):
        ...
        self.issue_db_command("INSERT INTO RelayOut VALUES(\
            \"%s\", \"%s\", \"%s\", \"%s\", \"%s\");"\
            % ("1", "192.168.0.1", "11011", "4", "1"))
        
        
        self.issue_db_command("INSERT INTO RelayOut VALUES(\
            \"%s\", \"%s\", \"%s\", \"%s\", \"%s\");"\
            % ("2", "192.168.0.15", "10012", "8", "1"))
        
        self.issue_db_command("INSERT INTO RelayOut VALUES(\
            \"%s\",\"%s\",\"%s\",\"%s\",\"%s\");"
            % ("3", "192.168.0.23", "10013", "8", "2"))
        
        self.issue_db_command("INSERT INTO UninitializedRelay VALUES(\
            \"%s\",\"%s\",\"%s\",\"%s\",\"%s\");"
            % ("4", "192.168.0.23", "10014", "8", "2"))
        ...
        self.issue_db_command("INSERT INTO SolenoidOut VALUES(\
            \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\");"\
            % ("5", "mainDrip", "2", "1", "1", "off", "0"))
        
        self.issue_db_command("INSERT INTO SolenoidOut VALUES(\
            \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\");"\
            % ("6", "hydroponic", "2", "6", "1", "off", "0"))
        
        self.issue_db_command("INSERT INTO SolenoidOut VALUES(\
            \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\");"
            % ("7", "mainDrip", "3", "1", "2", "off", "0"))
